...
<?php require 'header.php' ?>
    ...
    <div class="container-fluid bg-light py-5">
        <div class="col-md-6 m-auto text-center">
            ...
            <p>
                We would love to hear from you, whether you are curious about features
                or even return, we are ready to answer any and all your questions.
            </p>
        </div>
    </div>

    <!-- Start Contact -->
    <div class="container-fluid py-5" style="background:url('contactbackground.jpeg'); background-size:cover">
        <div class="row py-5">
            <form action="send_msg.php" class="col-md-9 m-auto" method="POST" role="form">
                <div class="row">
                ...
                <div class="row">
                    <div class="col text-end mt-2 text-center">
                        <button type="submit" id="lets_talk" class="btn btn-success btn-lg px-3">Let’s Talk</button>
                    </div>
                </div>
            </form>
        </div>
  ...
  btn.addEventListener("click", function(){
       ...
       if(name == ""){
            ...
            swal ("", "Email field is missing", "error");    
                ...
                swal ("", "Please enter your subject", "error");    
            }
        })
